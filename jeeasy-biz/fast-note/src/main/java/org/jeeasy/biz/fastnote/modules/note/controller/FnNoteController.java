package org.jeeasy.biz.fastnote.modules.note.controller;
...
@Tag(name = "FastNote笔记")
@RequestMapping("/manage/fn/note")
public class FnNoteController extends SimpleBaseController<FnMemberService, FnMember> {
